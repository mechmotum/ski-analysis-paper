...
\begin{abstract}
  ...
  %\todo{If we are going to state this (in the abstract) we need to have citable
  %evidence. Not sure we provide that in the paper. -- JM}  - sentence modified MH
...
\begin{figure}
  ...
  %Orange lines indicate relatable fall heights.
  }
