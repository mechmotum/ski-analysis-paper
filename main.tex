...
\begin{abstract}
  Most American snowsport resorts have terrain parks. Decades of
...
perpendicular to impacting surfaces, provide greater injury potential due to
increased kinetic energies to be dissipated. Equivalent fall height' (EFH) is
conceptually simple and familiar indication of impact danger used in safety
...
considered because of clear connections to injuries risk and  it can be used
easily to design and construct jumps.

Societal costs of jump injuries are discussed here with case studies that
illustrate dangers if EFH is not limitd appropriately. We discuss papers
...
personal injury law suits Proposals for improve safety are absent. We  present
...
participation.  Jumps proliferated since and today they are nearly ubiquitous.
...
injuries~\cite{Alvarado2002,Salvini2008}. Simulation follow from methods in
