...
2021) to assist work described here. New library features automate
...
Microsoft Excel spreadsheet file. Jumps are then analyzed and EFHs are
...
that refinements and modifications are easy and encouraged. The software was designed to be extensible and modular. New surface
...
features and actions. We make use of this flexibility for web
application and for calculations and visualizations presented in the
following section.
...
of the knuckle (before the end of the table-top). This table-top was not flat and
horizontal as is typical. Instead it was concave, compounding dangers of short landings. At the
11~\si{\meter} landing horizontal distance measured from  takeoff, the surface
sloped upwards approximately 5\si{\degree}. Concave table tops exacerbate
detrimental effects of failing to align landing zone tangents close to jumper flight
paths at impact.
%
\begin{figure}
  \centering
...
greatest just short of the knuckle, ending the table top. At the sweet spot, just past the knuckle,
...
paralyzed. Lower EFHs decrease risks of injury, with lower
impact forces for similar adsorptions.

Jumps with smaller EFHs can be created at
similar costs. The green jump profile in the upper panel of
...
constant (small) EFHs of about 1~\si{\meter}. The convex shape of this jump
...
requires significantly more snow than the measured jump but limits EFH to 1 m. This jump highlights how extreme EFHs can become if jumps
are not properly designed.  Nobody would voluntarily jump out of three story
windows, snow or not, as injuries are clearly likely. Our internal altimeter tells
us so. It is impossible for recreational skiers to evaluate EFHs by looking at jumps.

These two case studies demonstrate that deficient jump landing shapes
have devastating consequences and that engineering analysis and design, based
on well-established laws of mechanics, could be used to design jumps that limit EFHs safely.
Designing jumps this way is based on mechanics elucidated centuries ago by 
Isaac Newton and Émilie du Châtelet~\cite{Zinsser2007}, fundamental to
physics and engineering education. Designing jumps to limit EFHs unquestionably
reduces injury risk by reducing impact energies and associated forces.
...
not a matter of opinion and should not be optional, but rather is the foundation for
...
to control EFHs with ethical design algorithms and software. Nonetheless ski industries and
...
on the fundamental physics of EFHs during litigation. Publications cited by the defense in
...
findings but we do question their interpretation of their findings, namely their
conclusion that greater fall height a basic indicator of greater risk of injury.
...
leads to further injuries, clearly contradictory to ethical engineering. Engineering experts defending ski industries and  engaging in these practices could be complicit in continued societal
damage, and doing harm to the safety, health, and welfare of the public. Certainly they might not think so.  As Upton Sinclair wrote ``it is difficult to get a man to understand
...
users''~\cite{NSAA2008}, none of these in fact preclude EFH analysis and rationale engineering design.
...
suits, and reject these submissions. Paper submissions whose findings help to perpetuate dangerous practices for the short-term financial benefit of industry and which apparently do nothing for the safety, health, and welfare of the public, are unethical and do not
...
construction of more complex designed shapes precisely and accurately to within tens of centimeters. These would include the
...
jump is safe before trying it. Appropriate inspection, evaluation, correction, and maintenance of existing jumps, and the design and construction of safer new
jumps should be promoted.  Postings should be required and include EFHs, the
certified inspectors name, and when last inspected and maintained.  Inspections should be
frequent enough to ensure that jumps meet safe design standards, particularly regarding
takeoffs and starting points to prevent inadvertent inversions due to take off ramp curvature. Standards need
...
program, around 1980 ASTM Committee F27 began to develop ski binding standards. ASTM is an American based organization for a wide variety of consensus standards. Committee F27 was created in 1982 for skiing safety, which had been a subcommittee, created from a working group in 1972, of F8 Committee on Sports Equipment. Participation in F27 is international.   
...
because release value measurement was impossible by ski shops, just as now industry now
...
no medical professionals and almost no academics remain in ASTM F27. Efforts to
create similar standards for terrain park ski jumps began in F27 more than a
decade ago~\cite{SAM2011}, yet no standards have yet been developed with any appearance of providing safety for th public. The US
...
for ski resorts to proactively better terrain park safety than they do now. Accurate enough
...
With this software, jump builders could add safety assessment to their
