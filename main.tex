...
designs. In fact, safety research ~\cite{Smith2019} tells us that designing forgiving environments (i.e. limiting EFH at all possible landing locations) is more effective than forcing behavioral change (i.e. requiring the jumper to regulate their speed to ensure a landing only in a small safe region).
