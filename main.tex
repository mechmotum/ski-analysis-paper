...
\begin{abstract}
  ...
  companies are resisting making terrain park jumps safer in this way.\todo{If we are going to state this (in the abstract) we need to have citable evidence. Not sure we provide that in the paper. -- JM} We
