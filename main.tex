...
with the method described in the prior section.
%
\begin{listing*}
  \begin{minted}{pycon}
>>> from skijump.functions import cartesian_from_measurements
>>> dis = [14.5, 15.0, 15.5, 16.0, 16.5, 17.0]
>>> ang = np.deg2rad([4.6, -7.4, -16.5, -9.7, -11, -6.9])
...
0.08028514559173916
  \end{minted}
  \caption{Python interpreter session showing how one could compute the
  Cartesian coordinates from equivlanten fall height of a measured jump.}
