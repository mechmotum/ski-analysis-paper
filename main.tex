...
interpretability by people. People have builtin danger sensors when faced with
...
floor falls are on the order of 1.5~\si{\meter}, second storey are
4.6~\si{\meter}, third storey~\si{\meter}, fourth storey 10.7~\si{\meter} and
so on~\cite{Vish2005}. OSHA considers 1.8~\si{\meter} fall heights beyond the
acceptable limit for workplace safety and the FAA's safety regulations for safe
parachuting landings is a 3~\si{\meter} fall height. As for skiing, the
standards for the Olympic ski jumping call for equivalent fall heights of
0.46~\si{\meter}.
