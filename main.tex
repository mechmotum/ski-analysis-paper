...
skiing industry continues to resist more scientifically-based rational approaches to design, in spite of the fact that computer aided design (and even automated
...
for more than 5 years~\cite{Muigg2019}. The 2015 NSAA reference in~\cite{NSAA2015} still contained the statement that "Standards are essentially impossible..." We expect the 2021 version does too.
...
distances and slopes (deck length, takeoff angle, landing region angle and length, etc.)during the process. But the design concepts are overly simple and do not
...
we have made available for jump designers and builders has almost instantaneous calculation and visualization steps.

With this tool jump builders can easily add
...
safer terrain park jumps. As shown in the case studies above, jumps
can have EFHs comparable to falling from aerial ski lifts. Just like rules enforced by states and insurance companies to prevent falls from lifts, similar standards
are needed for terrain park jumps. Public safety must be held paramount to short-term return-on-investment.
...
The methods and software we have illustrated in Section 2.2 provide a starting
...
that safety is made integral to jump design. The software can grow and evolve
