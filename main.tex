...
\corrauthor[1]{Jason~K. Moore}{j.k.moore@tudelft.nl}

% the template doesn't seem to support this command
...
including Cython~\citep{Behnel2011}, matplotlib~\citep{Hunter2007},
NumPy~\citep{Oliphant2006}, pandas~\citep{McKinney2020}, Plotly \&
Dash~\citep{Plotly2015}, pycvodes~\citep{Dahlgren2018},
SciPy~\citep{Virtanen2020}, SymPy~\citep{Meurer2017}, and xlrd. This software
...
injuries~\citep{SuperiorCourtSanFranciscoCounty2002,KingCountySuperiorCourt2008}.
...
\begin{figure}
  ...
  speed~\citep{Levy2015} for a comparison jump (solid green) shaped to have
...
stories~\citep{Vish2005}.  She had also rotated backward in flight, landed on
...
speeds~\citep{Shealy2005}, rotated backward during flight and landed on his
...
centuries ago by Isaac Newton and Émilie du Châtelet~\citep{Zinsser2007}, and
...
public''~\citep{NSPE2019}, is the first canon of engineering ethics. Ethics is
...
for Accident Prevention~\citep{Heer2019}.
...
surgeons and academic researchers~\citep{Bahniuk1996}. Industry argued that
...
jumps~\citep{NSAA2015}. Nevertheless certifications and inspection standards
for bindings were developed, which led to fewer lower-extremity
equipment-related injuries~\citep{Bahniuk1996}.
...
more than a decade ago~\citep{SAM2011}, yet no standards have yet resulted with
