...
features and actions. We make use of this flexibility for the web
...
\label{sec:vine}
%
In April 2000, Ms.~Vine's lower spine was injured when she landed badly while jumping on skis at Bear Valley in California. The jump shape
...
of the knuckle, defined as the end of the table-top. This table-top was not flat and
...
EFH drops precipitously to  about 1~\si{\meter}, although landing in this narrow
region requires jumpers to control takeoff speeds very accurately to within about 
1~\si{\meter\per\second}.  Landing at 11 meters, Vine's EFH was instead almost 4
...
paralyzed. Lower EFH would have decreased risk of injury, due to lower
impact forces.
...
constant (small) EFHs of about 1~\si{\meter}. Interestingly, the convex shape of this jump
is close to the original concave table-top  inverted, showing
...
us so, but it is impossible for recreational skiers to evaluate EFHs simply by looking at jumps.
...
Isaac Newton and Émilie du Châtelet~\cite{Zinsser2007}, and fundamental to
...
jump is not unsafe before trying it. Appropriate inspection, evaluation, correction, and maintenance of existing jumps, and the design and construction of safer new
...
inspection, and maintenance. ASTM, an American organization for a wide variety of consensus standards, provides a historical example of a successful certification
program. ASTM Committee F27 was created in 1982 for skiing safety and began to develop ski binding standards.  
Proponents were led by orthopedic surgeons and academic
researchers~\cite{Bahniuk1996}. Industry argued that standards were unattainable
because release value measurement was impossible by ski shops, just as industry now
...
to fewer lower-extremity equipment-related injuries~\cite{Bahniuk1996}. 
...
decade ago~\cite{SAM2011}, yet no standards have yet resulted with any
appearance of increasing safety for the public. The US
