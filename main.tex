...
which it can be controlled for.~\todo{Maybe we should also mention that shortening the approach, and thus max possible speed, is the first and simplest adjustment for decreasing injury - JM}.
...
%that injury from impact is much more likely. 
