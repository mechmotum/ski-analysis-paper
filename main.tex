...
expert testimony for defending the ski industry in personal injury lawsuits.
...
risks of serious spinal injuries. Similar suggestions appeared in peer-reviewed
...
Fundamental laws cannot be disproved with these kinds of jumping experiments,
regardless of expensive instrumentation. If statistics or experimental results
...
there are far fewer lower-extremity equipment-related injuries. Now in F27, no
...
jumps meet the standards, particularly regarding takeoffs and starting points to prevent
...
consuming relatively little time per jump, see the supplementary materials for
...
made a user-friendly, freely-accessible online web application available with
the calculation and visualization steps almost instantaneous for jump builders.
With the tool described in the Methods section, jump builders can easily add this
...
\todo[inline]{Mont will take Chris's text (below) and also cite his prior paper that deals with all the limitations and make this final paragraph}
A limitation to reducing injuries, especially paralysis, on terrain park jumps is that it cannot be accomplished just by publishing papers on scientific design methods and providing software. Industry must adapt ethical procedures for designing, building, inspecting, and maintaining safe terrain park jumps. Just like rules, enforced by states and insurance companies, to keep people from falling from aerial ski lifts, they are needed for terrain park jumps. Current jumps have EFHs like falling from chair lifts. Public safety must be held paramount to short-term return-on-investment. Journal editors need to recognize papers primarily intending to cast doubt on good science and engineering for what they are, tools of insurance companies for defending civil suits, and reject them.  Engineers, whose work unethically ignores their first canon of ethics, in favor of merchanting doubt, should not edit engineering journals or organize engineering conferences, because these journals' and conferences' reputation is at risk. 
