...
of takeoff speed~\cite{Petrone2017}, because landing hill shapes, its tangent or slope, alignes with jumpers' trajectories, which have similar shapes regardless of speed, however with sufficient speed, corresponding to less friction, air drag, and higher starting points, the hill could be outjumped. To analyze a jump, it is sufficient to
...
%~\todo{LET'S EXPLAIN WHY SPEED CAN BE IGNORED -- CB}. the ref does this- MH Can we explain this in a sentence here? It seems counter intitutive. SLOPE CHANGES WITH THE SCALE OF CALCULATION - HOW DETAILED DO THE DATA NEED TO BE? WHAT ABOUT CURVATURE OF TAKE-OFF?
...
showing that convex landing shapes are critically important for controling equivalent fall heights. This alternative jump design would have lowered impact
...
designing jumps can reduce injury risk by limiting equivalent fall heights and
...
public''~\cite{NSPE2019}, is the first canon of engineering ethics. The moral imperative of enginering ethics motivates us to do work. In the context of snow sport safety, the first canon
...
equivalent fall heights with good enginering design practices. Nonetheless the skiing
industry and their insurance companies seem reluctant adopt such design methods. Engineers they hire as expert witnesses work to sow doubt on this basic physics. What can their motivation be? If work does not adhere to the first canon of engineering ethics, it is not engineering. People doing this unethical work are not really engineers.
...
proven science as a basis for changes in practice, the common strategic
...
fundamental, scientific concept of landing hill design, based on equivalent
...
%People unfamiliar with legal, healthcare and insurance systems in the USA may fail to appreciate how technical literature is often corrupted in legal defense of unsafe practices and to protect corporate assets. Peer-reviewed technical literature is often used to support testimony in U.S. lawsuits. Both plaintiffs and defendants hire their own experts to testify and authors of technical papers can make money by testifying. When this testimony is for the defense, it can result in denying compensation for injuries, and serve to prolong unsafe practices. The healthcare systems in the US can leave families destitute with no recourse but to sue to have resources to retain basic possesions, like a car and home, which can require expensive modifications. Rarely do experts report conflicts of interest in their papers and presentations, or when they organize and chair meetings or edit publications. Financial support for publications used by expert witnesses can be routed through consulting companies to pretend plausible deniability of conflicts of interest in their papers. Sadly, this is deceitful, self-serving, and unethical, because it ignores the first canon of engineering ethics. It could be argued that, if someone ignores engineering ethics, they are not acting as engineers, and what they are doing cannot be considered engineering.

\todo[inline]{Add paragraph here that squishes the next 3 paragraphs into 1. This paragraph should retain the ability for the readers to judge for themselves whether the science is bad and supports our conjecture that the authors and ski industry are following the same patterns as these other industries (tobacco, etc.). We should tone down the explicit claims of unethical-ness.}
