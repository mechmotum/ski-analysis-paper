...
$(x,y)$. Curvature in the last several meters before takeoffs can cause unintentional inversion, although this does not influence EFHs.
...
are not properly designed.  Few recreational skiers will jump out of three story
windows, snow or not, as injuries are clearly likely. Our internal altimeter tells
us so, but it's not easy to discern when visually assessing a jump's safety.~\todo{I learned that fear of falling is one of two innate fears humans have. See \url{https://en.wikipedia.org/wiki/Fear_of_falling}. I could add a citation here if it is warranted - Jason}
...
on laws of mechanics, could be used to shape jump landings that limit EFHs.
