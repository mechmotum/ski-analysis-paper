...
such design methods. There is an ethical choice skiing industries make between spend money and energy on litigation defense instead of spending it on technology for constructing safer jumps. They hire expert witness engineers to sow doubt on simple,
...
insurance companies. We do not fundamentally question their empirical findings but we do reject their interpretation of the findings, namely their conclusion that greater fall height is not a causation of greater injury.
...
classical mechanics, the problems are most certainly with the statistical or experimental design or their interpretations, but not fundamental laws of mechanics. Defending practices that lead to injuries helps prolong these dangerous practices, which leads to further injuries, clearly contradictory to ethical
engineering. Ski industry defense engineering experts are complicit in the continued societal damage. As Upton Sinclair wrote ``it is difficult to get a man to understand something when his salary depends on his not understanding it''~\cite{Sinclair1994}.
...
American legal, healthcare and insurance systems also corrupt technical literature for legal defense of unsafe practices. Peer-reviewed technical literature is
...
\label{sec:action}
Absolutely, the most important change will be to to incorporate rigorous, rational  processes and scientific principles into designing freestyle jumps. At present a large fraction of, if not most, jumps in the USA are created in a formulaic way using two straight lines, a horizontal deck (tabletop) and nearly constant-slope landing region, linked by a curved knuckle. There is literally no consideration of jump safety from the point of view of EFH beyond seat-of-the-pants "experience" of the so-called designer. Although such jumps are simple and thus "easy" to design, previous research has shown that, as a class, jumps with bi-linear geometry have generally poor EFH behavior~\cite{Swedberg2012}. The skiing industry resists scientifically-based rational approaches to design, in spite of the fact that computer aided design (and even automated fabrication) of snow park jumps (see Figure~\ref{fig:prinoth}) has been available from snow groomer manufacturers for more than 5 years.  ~\cite{Muigg2121,Prinoth2121}. 
...
\begin{figure}
  ...
  \caption{\textbf{Commercial availability of computer-aided design and control of fabrication of snow park surfaces began before 2016.} The right panel shows a computer generated 3-D jump landing surface with a family of simulated jumper paths, even ones outside the central bisecting plane, with the landing surface colored corresponding to the EFH incurred by the jumper at that landing point. The left panel shows a computer-controlled snow groomer fitted with two GNSS receivers that allow real time measurement of their position to an accuracy of about 2 cm, calculation of the yaw and roll of the groomer blade, and precise closed loop control of the snow addition and removal process. 
  Images courtesy of Prinoth, official supplier of snow groomers for the winter Olympics in China 2022.}
  \label{fig:prinoth}
\end{figure}

Once the jump surface has been designed, the next most important change is to base jump fabrication on scientific principles rather than just pushing snow until it "looks good". Presently a dominant fraction of jumps are simply fabricated by groomer operators and based on perhaps a few measurements of slopes (takeoff angle, landing region angle, etc.) during the process but the design concepts are overly simple. The introduction of computer controlled grooming, similar to computer controlled (CNC) machining, will facilitate construction of more complex shapes such as constant EFH surfaces. First year engineering students are able to machine components in two or three lab sessions using CNC that previously were only within reach of aspiring machinists after several weeks of their apprenticeship (WPI ME1800).

Appropriate inspection, evaluation, and correction of existing jumps, and the design and construction of safe new jumps should be promoted. Ski area
...
no medical professionals and almost no academics remain. Efforts to make standards on terrain park ski jumps started a decade ago~\cite{SAM2011}, yet standards on equivalent fall heights have yet to issued,
...
level, and consume relatively little time per jump (see supplementary
...
Should we remove the following paragraph
...
should not occur. Injured people require appropriate care that should not depend on
